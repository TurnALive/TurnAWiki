...
TurnAlive 目前开启了白名单验证机制，你需要先申请白名单通过后才能加入服务器。在申请前强烈建议先阅读[开幕（新人指南）](/Play/Opening)和[服务器成文规则（详明版）](/Play/Rules)两章和相关页面。
...
1. 按你的偏好填写标题和内容，但至少包含以下几点：
    ...
    - 你是否在特定社区或被被某玩家邀请（若填写此条下方的自我描述可以适当简化，若无则请相对详细的描述一下）
...
## 等待申请结果
1. 管理员一般会在申请发出的 72 小时内联系你，还可能会要求你回答一些额外的问题。当你收到白名单申请通过的通知后即可参考[开幕（新人指南）](/Play/Opening)开始你的 TurnAlive 之旅