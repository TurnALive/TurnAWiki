...
服务器目前暂未开启白名单，但我们依然强烈建议你读完本Wiki中的内容。

如果你距离上一次玩 Minecraft 这款游戏已经很久了，推荐查看[更新速览](game/UpdateOverview)页面，与 Minecraft 重新熟悉起来，能够很好的提升你的游戏体验。
...
创造铁路的右侧前往创造大厅，生存则需要使用 `/server survival` 指令前往。若你希望在创造开始你的游戏之旅则请额外注意本服务器安装了 Fast Async WorldEdit/Arceon 等插件，如需使用请向管理员申请加入创造者权限组。
